...
How to configure the **Amazon Redshift** data source (`grafana-redshift-datasource`) in Grafana.
...
- [Redshift Details](#redshift-details)
...
| | |
|---|---|
| Shown when | `jsonData_useServerless != true` |
...
| | |
|---|---|
| Shown when | **useManagedSecret** is **AWS Secrets Manager** (`true`) |
...
| | |
|---|---|
| Shown when | `jsonData_useServerless != true || jsonData_useManagedSecret == true` |
| Required when | `jsonData_useServerless != true && jsonData_useManagedSecret != true` |
