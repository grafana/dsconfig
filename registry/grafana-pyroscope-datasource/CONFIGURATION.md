...
How to configure the **Grafana Pyroscope** data source (`grafana-pyroscope-datasource`) in Grafana.
...
Minimal step used for metric query. Should be the same or higher as the scrape interval setting in the Pyroscope database.
